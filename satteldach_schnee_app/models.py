...
class SatteldachSchneeModel(models.Model):
    ...
    satteldach_schnee_eingegeben = models.BooleanField(blank=False)
    ...
    def get_absolute_url(self):
        return reverse('satteldach_schnee_app:satteldach_schnee_redirect', kwargs={'slug': self.projekt.slug,'my': self.projekt.pk,'pk': self.pk})

    def get_absolute_url2(self):
        return reverse('satteldach_schnee_app:satteldach_schnee_update', kwargs={'slug': self.projekt.slug,'my': self.projekt.pk,'pk': self.pk})

    def get_absolute_url3(self):
        return reverse('satteldach_schnee_app:satteldach_schnee_detail', kwargs={'slug': self.projekt.slug,'my': self.projekt.pk,'pk': self.pk})
