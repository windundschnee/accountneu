...
\geometry{left=1.3cm,right=0.8cm,top=0.75cm,bottom=2.2cm,marginparwidth=0cm , includehead}%
...
\newcommand\BackgroundStructure{%Command to specify the background of each page
	...
	\put(13, 270.5){\line(1,0){188}}%Horizontale linie unter der Kopfzeile
	\put(163, 8){\line(0,1){260.0}}%Vertikale linie links von margin
