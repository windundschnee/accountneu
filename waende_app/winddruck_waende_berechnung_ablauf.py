...
def winddruck_waende_berechnung_ablauf(self,eingaben_waende_berechnung):
    ...
    ergebnisse_aussen_nord_sued=aussenwinddruck_waende_berechnung(self,hoehe,b_west,b_sued,anzahl_streifen,fehlende_korrelation_beruecksichtigen)
    ergebnisse_aussen_ost_west=aussenwinddruck_waende_berechnung(self,hoehe,b_sued,b_west,anzahl_streifen,fehlende_korrelation_beruecksichtigen)
